...
const ANIMAIS = [
  {
    ...
    recorrente: false,
    escolha: null,
    poder: 'Espeta e manda pro ralo todos os animais das duas espécies mais fortes presentes na fila.',
    nota: 'Nunca espeta outros porcos-espinhos. "Espécie", não "carta": se houver dois tubarões, os dois vão.',
  },
  {
    id: 'tucano',
    nome: 'Tucano',
  ...
  },
  {
    ...
    recorrente: false,
    escolha: null,
    poder: 'Sozinho não faz nada. Ao chegar um segundo babuíno, a dupla expulsa todos os elefantes e tubarões da fila e vai para a frente de todos.',
    nota: 'A bagunça é disparada pela chegada do segundo babuíno.',
  },
  {
    id: 'polvo',
    nome: 'Polvo',
  ...
  },
  {
    ...
    nota: 'Se a inversão colocar o pinguim à frente de um tubarão ou elefante, ele sofre as ações deles.',
  },
  {
    id: 'cavalo',
    nome: 'Cavalo',
    ...
    recorrente: true,
    escolha: null,
    poder: 'Barreira viva: elefantes não o ultrapassam, e tubarões não o ultrapassam nem o comem.',
    nota: 'É um efeito passivo e permanente enquanto ele estiver na fila.',
  },
  {
    id: 'pavao',
    nome: 'Pavão',
  ...
  },
  {
    ...
    nota: 'Reorganiza tudo de uma vez, incluindo a própria águia.',
  },
  {
    id: 'tubarao',
    nome: 'Tubarão',
    ...
    nota: 'Para imediatamente ao encontrar um animal mais forte ou um cavalo.',
  },
  {
    id: 'elefante',
    nome: 'Elefante',
    ...
    nota: 'Não ultrapassa outro elefante, nem o lobo alfa, nem o cavalo.',
  },
  {
    id: 'lobo',
    nome: 'Lobo Alfa',
    ...
    recorrente: false,
    escolha: null,
    poder: 'Expulsa todos os babuínos da fila e assume a primeira posição, colado na porta do bar.',
    nota: 'Se já houver um lobo alfa na fila, o recém-jogado vai direto para o ralo.',
  },
];
